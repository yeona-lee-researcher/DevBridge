      ...
      <main style={{ maxWidth: 1200, margin: "0 auto", padding: "0 20px" }}>
        ...
        <section style={{ marginBottom: 80, paddingTop: 96 }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 28 }}>
            ...
            <button onClick={() => navigate("/project_register")} style={{ background: "none", border: "none", color: "#6B7280", fontSize: 14, cursor: "pointer", display: "flex", alignItems: "center", gap: 2, whiteSpace: "nowrap", flexShrink: 0, marginLeft: 32, fontFamily: BASE_FONT }}>
